...
public class LeaveMenu extends javax.swing.JFrame {
    ...
    private void CheckLeavebtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CheckLeavebtnActionPerformed
        EmployeeCheckLeave checkleave = new EmployeeCheckLeave();
        checkleave.setVisible(true);
        
        this.dispose();
    }//GEN-LAST:event_CheckLeavebtnActionPerformed

    private void ApplyLeavebtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ApplyLeavebtnActionPerformed

        EmployeeApplyLeave applyleave = new EmployeeApplyLeave();
        applyleave.setVisible(true);
        
        this.dispose();
    }//GEN-LAST:event_ApplyLeavebtnActionPerformed
